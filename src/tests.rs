...
fn slice(){
    ...
    vector.add(9);
    assert_eq!(vector.v,vec![3,6,9]);
    assert_eq!(vector.slice(3,6),vec![3]);
    assert_eq!(vector.slice(6,9),vec![6]);
    assert_eq!(vector.slice(6,6),vec![]);
    vector.remove(3);
    assert_eq!(vector.v,vec![6,9]);
    vector.remove(2);
    assert_eq!(vector.v,vec![6,9]);
    ...
    vector.add(4);
    assert_eq!(vector.v, vec![-5,-2,-1,0,4,8,9]);
    assert_eq!(vector.slice(-2,4),vec![-2,-1,0]);
    vector.remove(9);
    assert_eq!(vector.v, vec![-5,-2,-1,0,4,8]);
    vector.remove(8);
    assert_eq!(vector.v, vec![-5,-2,-1,0,4]);
    ...
    vector.add(-18);
    assert_eq!(vector.v, vec![-25,-18,0,1,11,16]);
    assert_eq!(vector.slice(-25,23),vec![-25,-18,0,1,11,16]);
    assert_eq!(vector.slice(12,20),vec![16]);
    assert_eq!(vector.slice(-1,1),vec![0]);
    assert_eq!(vector.slice(-40,-20),vec![-25]);
    assert_eq!(vector.slice(-40,-30),vec![]);
    assert_eq!(vector.slice(30,40),vec![]);
    assert_eq!(vector.slice(2,17),vec![11,16]);
    assert_eq!(vector.slice(17,2),vec![11,16]);
}